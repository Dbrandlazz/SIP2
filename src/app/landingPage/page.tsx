...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="leading-normal tracking-normal text-white gradient">
        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <h1 className="my-4 text-5xl font-bold leading-tight">
              Selamat Datang di SIP2
            </h1>
            <p className="uppercase tracking-loose w-full text-black">
              Sistem Indikator Pemilihan Program Studi
            </p>

            <p className="leading-normal text-2xl mb-8">
              Temukan program studi yang sesuai dengan minat dan bakat Anda!
            </p>
            <button className="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
              Cek minatmu sekarang
            </button>
          </div>

          <div className="w-full md:w-3/5 py-6 text-center">
            <Image
              src="/images/hero.png" // Path to your image
      ...
      <section id="about-us" className="bg-white border-b py-8">
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 sm:w-1/2 p-6">
              ...
              <p className="text-gray-600 mb-8">
                Sistem Indikator Pemilihan Prodi adalah sistem yang diciptakan
                untuk membantu calon mahasiswa atau siswa dalam menentukan prodi
                atau jurusan. Tujuan dari sistem ini adalah untuk memberikan
                panduan dan informasi yang lebih baik kepada calon mahasiswa
                agar mereka dapat membuat keputusan yang lebih terinformasi
                tentang pilihan prodi yang tepat untuk mereka.
                <br />
                <br />
              </p>
            </div>
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              <div className="align-middle">
                ...
                <p className="text-gray-600 mb-8">
                  Aplikasi ini menyediakan fitur tes bagi calon mahasiswa atau
                  siswa yang ingin mengetahui program studi apa yang cocok
                  sesuai dengan minat, bakat dan tujuan karir nya.
                  <br />
                  <br />
                </p>
              </div>
      ...
      <section id="prodi" className="bg-white border-b py-8">
        <div className="container mx-auto flex flex-wrap pt-4 pb-12">
          <a href="#prodi" className="w-full text-center">
            <h2 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
              Prodi
            </h2>
          </a>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  Program Studi Informatika didirikan pada tahun 2010 dan telah
                  meraih akreditasi A pada tanggal 16 September 2020. Sejak awal
                  berdiri, program studi ini telah menjadi pilihan favorit para
                  calon mahasiswa melaluberbagai jalur masuk ke perguruan
                  tinggi. Semua mata kuliah dalam program studi ini bertujuan
                  untuk menciptakan lulusan yang memiliki kualitas tinggi,
                  mandiri, kreatif,dan memiliki kemampuan analisis yang
            ...
            <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div className="flex items-center justify-start">
                <a
                  href="https://informatika.usk.ac.id/webinf/"
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  Program Studi Farmasi S1 Unsyiah berdiri pada 12 Januari 2011,
                  menjadi program studi keenam di Fakultas MIPA Unsyiah.
                  Pembukaannya didukung oleh berbagai pihak, termasuk Dinas
                  Kesehatan, BBPOM, IAI, Pemerintah Daerah, dan instansi terkait
                  lainnya, bertujuan untuk mendukung Program Indonesia Sehat
                  Tahun 2010 dan mengatasi kekurangan tenaga pelayanan
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  Program Studi S1 (Sarjana) Biologi merupakan salah satu dari 7
                  (tujuh) program studi yang ada di Fakultas Matematika dan Ilmu
                  Pengetahuan Alam (FMIPA) Universitas Syiah Kuala (Unsyiah)
                  Banda Aceh. Pendirian Prodi S1 Biologi Unsyiah merupakan salah
                  satu upaya menghasilkan sumber daya manusia yang mampu
                  menjaga, mengelola, dan mengembangkan potensi kekayaan
                  keragaman hayati yang terdapat di Aceh khususnya dan Indonesia
                  umumnya.
                </p>
              </a>
            </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  Program Studi S1 Statistika FMIPA Universitas Syiah Kuala
                  didirikan pada tanggal 24 Agustus 2012 dengan SK pendirian
                  Nomor 279/E/O/2012, dan mulai menawarkan Program Sarjana
                  Statistika pada Tahun Ajaran 2013/2014.
                </p>
              </a>
            </div>
            <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  Program Studi Fisika (PSF) FMIPA Universitas Syiah Kuala
                  didirikan pada tahun 1989 berdasarkan Surat Keputusan Direktur
                  Jenderal Pendidikan Tinggi Departemen Pendidikan dan
                  Kebudayaan RI No. 10/Dikti/Kep/1989 tanggal 17 Februari 1989.
                </p>
              </a>
            </div>
            <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
        ...
        <section className="bg-white border-b py-8">
          <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div className="w-full p-6 flex flex-col items-center">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow w-full md:w-2/3">
                <a
                  href="#"
                  className="flex flex-wrap no-underline hover:no-underline"
                >
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    Program Studi Farmasi S1 Unsyiah berdiri pada 12 Januari
                    2011, menjadi program studi keenam di Fakultas MIPA Unsyiah.
                    Pembukaannya didukung oleh berbagai pihak, termasuk Dinas
                    Kesehatan, BBPOM, IAI, Pemerintah Daerah, dan instansi
                    terkait lainnya, bertujuan untuk mendukung Program Indonesia
                    Sehat Tahun 2010 dan mengatasi kekurangan tenaga pelayanan
                    kefarmasian di Provinsi Aceh.
                  </p>

                  <div className="w-full p-6 flex items-center justify-center">
                    <a
                      href="https://m-math.usk.ac.id/"
                      className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                    >
                      Lihat lebih lanjut
                    </a>
      ...
      <footer className="bg-white">
        <div className="container mx-auto px-8 flex items-center justify-center h-full">
          <div className="text-black">
            <a
              href="https://www.freepik.com/free-photos-vectors/background"
              className="text-gray-500"
            >
              &copy; Copyright by Kelompok 10
            </a>
          </div>
        </div>
      </footer>
