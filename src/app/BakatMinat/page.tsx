...
import FloatingSVGs from "../../app/component/FloatingSVG";
...
const Diagnosis: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (answers.length === 0) {
      ...
      alert("Pilih setidaknya satu minat sebelum melakukan tes.");
      return;
    }
    ...
    <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      ...
      <div
        ...
        <ul className="list-reset lg:flex justify-end flex-1 items-center">
          <li className="mr-3">
            <a className="inline-block py-2 px-4 text-black font-bold no-underline" href="/index.html">Beranda</a>
          </li>
          <li className="mr-3">
