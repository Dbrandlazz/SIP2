...
import logo from "../../../public/images/logousk.png"
import Image from 'next/image';

const Navbar: React.FC = () => {
  return (
    <nav className="bg-[#929d90]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 " id="navbar-dropdown">
        <a
